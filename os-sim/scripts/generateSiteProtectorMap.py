'''
Generate Ossim Agent Dictionary to use with SiteProtector devices

Download http://www.iss.net/security_center/reference/vuln/ to a directory named "files"
Copy the SiteProtectorMap from the ossim-agent directory

Improve for Reliability and Risk evaluation
