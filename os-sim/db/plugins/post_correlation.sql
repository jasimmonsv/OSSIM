...
INSERT INTO plugin (id, type, name, description) VALUES (12001, 1, 'post_correlation', 'Alienvault post correlation engine');

INSERT INTO plugin_sid (plugin_id, sid, category_id, class_id, name, priority, reliability) VALUES (12001, 1, NULL, NULL, 'New suspicious host detected' ,3, 2);
