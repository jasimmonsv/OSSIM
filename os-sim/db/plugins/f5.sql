...
INSERT INTO plugin (id, type, name, description) VALUES (1614, 1, 'f5', 'F5:Device ');

INSERT INTO plugin_sid (plugin_id, sid, category_id, class_id, name, priority, reliability) VALUES (1614, 1, NULL, NULL, 'F5 load balancer: HTTP_RESPONSE', 1, 1);
INSERT INTO plugin_sid (plugin_id, sid, category_id, class_id, name, priority, reliability) VALUES (1614, 2, NULL, NULL, 'F5 load balancer: SSL Request', 1, 1);
INSERT INTO plugin_sid (plugin_id, sid, category_id, class_id, name, priority, reliability) VALUES (1614, 3, NULL, NULL, 'F5 load balancer: SSL Access', 1, 1);
INSERT INTO plugin_sid (plugin_id, sid, category_id, class_id, name, priority, reliability) VALUES (1614, 4, NULL, NULL, 'F5 load balancer: Generic ERROR', 5, 1);
INSERT INTO plugin_sid (plugin_id, sid, category_id, class_id, name, priority, reliability) VALUES (1614, 5, NULL, NULL, 'F5 load balancer: TCL ERROR', 5, 1);
INSERT INTO plugin_sid (plugin_id, sid, category_id, class_id, name, priority, reliability) VALUES (1614, 6, NULL, NULL, 'F5 load balancer: AUDIT Event', 1, 1);
INSERT INTO plugin_sid (plugin_id, sid, category_id, class_id, name, priority, reliability) VALUES (1614, 7, NULL, NULL, 'F5 load balancer: Uknown site', 1, 1);
