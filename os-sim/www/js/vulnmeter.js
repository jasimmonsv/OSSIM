    ...
    $('#dplugins').html(loading);
        $.ajax({
                ...
                success: function(msg) {
                    ...
                    document.getElementById('select_cve').style.display = 'block';
                    document.getElementById('select_cve').selected=true;
    ...
    if(filter!='Select CVE Id') {
        ...
        $.ajax({
                ...
                success: function(msg) {
                    ...
                    document.getElementById('select_family').style.display = 'block';
                    document.getElementById('select_family').selected=true;
                    $(".scriptinfo").simpletip({
                        position: 'right',
                        onBeforeShow: function() { 
                            var id = this.getParent().attr('lid');
...
function showDivPlugins(num, name, max, hidden, max2)
{
    ...
    if(name=='cve') {
        document.getElementById('select_family').style.display = 'block';
        document.getElementById('select_family').selected=true;
        document.getElementById('select_cve').style.display = 'none';
        document.getElementById('tick1').style.display = 'none';
        document.getElementById('tick2').style.display = 'block';
   }
}
