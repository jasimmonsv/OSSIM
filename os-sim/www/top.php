...
<div id="side-bar">
		...
		<?php if(Session::menu_perms("MenuReports", "ReportsHostReport") || Session::menu_perms("MenuStatus", "MonitorsSensors") || Session::menu_perms("MenuStatus", "ToolsUserLog") || Session::am_i_admin()) { ?>
        <ul class="jx-bar-button-right">
        	<li title="<?php echo _("Status")?>"><a href="<?php echo (Session::menu_perms("MenuReports", "ReportsHostReport") || Session::am_i_admin()) ? "report/host_report.php?hmenu=Sysinfo&smenu=Sysinfo&host=any&star_date=".date("Y-m-d",time()-604800)."&end_date=".date("Y-m-d") : ((Session::menu_perms("MenuStatus", "MonitorsSensors")) ? "sensor/sensor_plugins.php?hmenu=Sysinfo&smenu=Sysinfo" : "userlog/user_action_log.php?hmenu=Sysinfo&smenu=Sysinfo") ?>" target="main"><img src="pixmaps/status.png"></a></li>
        </ul>
        <?php } else { ?>
        <ul>
