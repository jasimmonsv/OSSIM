...
<input type="hidden" name="oldname" value="<?=$_SESSION['current_cview']?>">
    ...
    <tr><td class="center nobborder">
		...
		<?php }?>
		<input type="button" class="lbutton" onclick="document.fcols.selected_cols.value=getselectedcombovalue('cols');document.fcols.submit()" value="<?=($edit) ? _("Update") : _("Create")?>">
