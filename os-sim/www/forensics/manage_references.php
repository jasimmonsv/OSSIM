...
function formsubmit () {
	...
	&& document.frules.newref_value.value != '') {
		$.ajax({
			type: "GET",
			url: "manage_references_getrefs.php",
...
?>
<table class="transparent" width="95%" align="center"><tr><td class="nobborder">
			...
			<table class="transparent" height="100%">
				<tr>
					<td class="nobborder">
						...
						<?$i=1; foreach ($ref_types as $myrow) { $color=($i%2==0)?"#FFFFFF":"#F2F2F2";?>
							<tr bgcolor="<?=$color?>">
								...
								<td class="nobborder"><a href="" onclick="ref_delete(<?=$myrow[0]?>);return false;"><img src="../pixmaps/tables/table_row_delete.png" alt="<?=_("Delete")?>" title="<?=_("Delete")?>" border="0"></a></td>
							</tr>
						<?$i++; } ?>
							</form>
						</table>
			...
			<table width="100%" height="100%" class="transparent">
				...
				<tr>
					<td class="nobborder" valign="top">
						...
						<tr><th height="20"><?=_("New Reference")?></th></tr>
