...
function returnContents() {
    GLOBAL $language, $useauth, $adodb, $chartlib, $uri, $dbtype, $dbhost, $dbport, $dbname, $dbusername, $dbpasswd, $arcdbexists, $arcdbhost, $arcdbport, $arcdbname, $arcdbusername, $arcdbpasswd;
    $contents = '<?php
/*******************************************************************************
** OSSIM Forensics Console
** Copyright (C) 2009 OSSIM/AlienVault
