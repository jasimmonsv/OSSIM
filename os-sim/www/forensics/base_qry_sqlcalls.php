...
$qro->AddTitle("Asset &nbsp;<br>S<img src='images/arrow-000-small.gif' border=0 align=absmiddle>D");
...
$qro->AddTitle(_("L4-proto"));
$qro->AddTitle(_("Src IP"));
$qro->AddTitle(_("Src IP FQDN"));
$qro->AddTitle(_("Dst IP"));
$qro->AddTitle(_("Dst IP FQDN"));
$qro->AddTitle(_("Src Port"));
$qro->AddTitle(_("Dst Port"));
$qro->AddTitle(_("Userdata1"));
$qro->AddTitle(_("Userdata2"));
$qro->AddTitle(_("Userdata3"));
$qro->AddTitle(_("Userdata4"));
$qro->AddTitle(_("Userdata5"));
$qro->AddTitle(_("Userdata6"));
$qro->AddTitle(_("Userdata7"));
$qro->AddTitle(_("Userdata8"));
$qro->AddTitle(_("Userdata9"));
$qro->AddTitle(_("Username"));
$qro->AddTitle(_("Filename"));
$qro->AddTitle(_("Password"));
$qro->AddTitle(_("SID"));
$qro->AddTitle(_("CID"));
$qro->AddTitle(_("Plugin ID"));
$qro->AddTitle(_("Plugin SID"));
$qro->AddTitle(_("Plugin Description"));
$qro->AddTitle(_("Plugin Name"));
$qro->AddTitle(_("Source Type"));
$qro->AddTitle(_("Category"));
$qro->AddTitle(_("SubCategory"));
/* Apply sort criteria */
