...
require_once($GLOBALS["CONF"]->db_conf["jpgraph_path"]."jpgraph.php");
require_once($GLOBALS["CONF"]->db_conf["jpgraph_path"]."jpgraph_pie.php");
require_once($GLOBALS["CONF"]->db_conf["jpgraph_path"]."jpgraph_pie3d.php");
