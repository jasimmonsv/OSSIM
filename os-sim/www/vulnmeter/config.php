...
$dbtype = $GLOBALS["CONF"]->conf["ossim_type"];
$dbhost = $GLOBALS["CONF"]->conf["ossim_host"];
$dbname = $GLOBALS["CONF"]->conf["ossim_base"];
$dbuname = $GLOBALS["CONF"]->conf["ossim_user"];
$dbpass = $GLOBALS["CONF"]->conf["ossim_pass"];
