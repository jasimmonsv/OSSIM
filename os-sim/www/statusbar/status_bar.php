...
?>
<table cellpadding=0 cellspacing=0 border=0 height="22" width="100%" style="background:url('pixmaps/top/bg_header.gif') repeat-x bottom left;"><tr>
...
<td style="padding-left:10px;" width="20"><img src="pixmaps/statusbar/logo_siem_small.png" border=0></td><td style="color:black;text-align:left;font-size:11px;font-family:verdana;font-weight:bold"><?php echo gettext("AlienVault - ".($opensource ? "Open Source SIM" : ($demo ? "Professional SIEM Demo" : "Professional SIEM"))); ?></td>
