...
ossim_valid($id, OSS_DIGIT, OSS_SCORE, OSS_NULLABLE, 'illegal:' . _("id"));
if (ossim_error()) {
    die(ossim_error());
}
if ($directive == '' && $id == '') {
    ...
    if (!$onlydir) {
        ...
        $frames.= '<iframe id="bottom" width="100%" frameborder=0 marginwidth=0 marginheight=0 height="195px" STYLE="z-index:1;" src="editor/directive/index.php?directive=' . $directive . '&amp;level=' . $level . '&amp;id=' . $id . '" name="bottom" ></iframe>';
    } else {
