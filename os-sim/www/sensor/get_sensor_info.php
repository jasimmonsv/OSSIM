...
?>
  ...
  <td><a href="<?php
                echo "sensor_plugins.php?sensor=$ip&ip=$ip&cmd=stop&id=$id" ?>">
    <?php
...
?>
  ...
  <td><a href="<?php
                echo "sensor_plugins.php?sensor=$ip&ip=$ip&cmd=start&id=$id" ?>">
    <?php
...
?>
  ...
  <td><a href="<?php
                echo "sensor_plugins.php?sensor=$ip&ip=$ip&cmd=disable&id=$id" ?>">
    <?php
...
?>
  ...
  <td><a href="<?php
                echo "sensor_plugins.php?sensor=$ip&ip=$ip&cmd=enable&id=$id" ?>">
    <?php
...
<tr>
  <td colspan="7">
    <a href="<?php
    echo "sensor_plugins.php?sensor=$ip" ?>"> <?=_("Refresh")?> </a>
  </td>
</tr>
<?php
} // if
