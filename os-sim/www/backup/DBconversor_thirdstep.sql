...
REPLACE INTO acid_event SELECT * FROM tmp.acid_event;
REPLACE INTO acid_event_input SELECT * FROM tmp.acid_event_input;
REPLACE INTO extra_data SELECT * FROM tmp.extra_data;
REPLACE INTO ac_sensor_sid SELECT * FROM tmp.ac_sensor_sid;
REPLACE INTO ac_sensor_signature SELECT * FROM tmp.ac_sensor_signature;
REPLACE INTO ac_sensor_ipsrc SELECT * FROM tmp.ac_sensor_ipsrc;
REPLACE INTO ac_sensor_ipdst SELECT * FROM tmp.ac_sensor_ipdst;
REPLACE INTO ac_alerts_signature SELECT * FROM tmp.ac_alerts_signature;
REPLACE INTO ac_alerts_sid SELECT * FROM tmp.ac_alerts_sid;
REPLACE INTO ac_alerts_ipsrc SELECT * FROM tmp.ac_alerts_ipsrc;
REPLACE INTO ac_alerts_ipdst SELECT * FROM tmp.ac_alerts_ipdst;
REPLACE INTO ac_srcaddr_ipsrc SELECT * FROM tmp.ac_srcaddr_ipsrc;
REPLACE INTO ac_srcaddr_sid SELECT * FROM tmp.ac_srcaddr_sid;
REPLACE INTO ac_srcaddr_signature SELECT * FROM tmp.ac_srcaddr_signature;
REPLACE INTO ac_srcaddr_ipdst SELECT * FROM tmp.ac_srcaddr_ipdst;
REPLACE INTO ac_dstaddr_ipdst SELECT * FROM tmp.ac_dstaddr_ipdst;
REPLACE INTO ac_dstaddr_sid SELECT * FROM tmp.ac_dstaddr_sid;
REPLACE INTO ac_dstaddr_signature SELECT * FROM tmp.ac_dstaddr_signature;
REPLACE INTO ac_dstaddr_ipsrc SELECT * FROM tmp.ac_dstaddr_ipsrc;
REPLACE INTO ac_layer4_sport SELECT * FROM tmp.ac_layer4_sport;
REPLACE INTO ac_layer4_sport_sid SELECT * FROM tmp.ac_layer4_sport_sid;
REPLACE INTO ac_layer4_sport_signature SELECT * FROM tmp.ac_layer4_sport_signature;
REPLACE INTO ac_layer4_sport_ipdst SELECT * FROM tmp.ac_layer4_sport_ipdst;
REPLACE INTO ac_layer4_dport SELECT * FROM tmp.ac_layer4_dport;
REPLACE INTO ac_layer4_dport_sid SELECT * FROM tmp.ac_layer4_dport_sid;
REPLACE INTO ac_layer4_dport_signature SELECT * FROM tmp.ac_layer4_dport_signature;
REPLACE INTO ac_layer4_dport_ipsrc SELECT * FROM tmp.ac_layer4_dport_ipsrc;
REPLACE INTO ac_layer4_dport_ipdst SELECT * FROM tmp.ac_layer4_dport_ipdst;
