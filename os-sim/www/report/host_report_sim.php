...
<table align="center" width="100%" class="bordered">
	<tr>
		<td class="headerpr"><a style="color:black" href="../forensics/base_qry_main.php?num_result_rows=-1&submit=Query+DB&current_view=-1&sort_order=time_d&ip=<?php echo urlencode($host)?>&date_range=All"><?php echo gettext("SIEM Events"); ?></a></td>
	</tr>
	<?php
	// GRAPH
	...
	<tr>
		<td style="text-align:center">
			<table align="center" style="width:auto">
				<tr>
					<td nowrap style="text-align:left"><b><?php echo $sim_numevents?></b> <?php echo gettext("SIEM total unique events<br> in <b>selected range</b>"); ?></td>
		...
		<td>
			<table>
				<tr>
					...
					{ 
						$host_txt = ( $host == 'any') ? _("No Unique Events found in the System") : _("No Unique Events found for")."<i>".$host."</i>"; 
						?>
					...
					?>
						<tr>
							...
							<?php if ($network) { ?><th><?php echo _("IP src"); ?></th><? } ?>
							<?php if ($network) { ?><th><?php echo _("IP dst"); ?></th><? } ?>
							<th><?php echo _("Sensor #"); ?></th>
							<th><?php echo _("Src/Dst Addr."); ?></th>
							<th><?php echo _("Graph")?></th>
						</tr>
						<?php 
						$i = 0;
			...
			<table height="100%">
				<tr>
					<td width="33%" valign="top">
						<table height="100%">
							<tr><th height="10"><?php echo _("Destination Ports")?></th></tr>
							<?php 
							if (count($sim_ports) < 1) 
							{ 
								?>
								<tr><td><?php echo _("No ports found")?></td></tr>
								<?php 
							} 
							else 
							{ 
					...
					<td width="33%" valign="top">
						<table height="100%">
							<tr><th height="10"><?php echo _("Event Sources")?></th></tr>
							<?php 
							if (count($sim_ipsrc) < 1) 
							{ 
								?>
								<tr><td><?php echo _("No sources found")?></td></tr>
								<?php
							} 
							else 
							{ 
					...
					<td width="33%" valign="top">
						<table height="100%">
							<tr><th height="10"><?php echo _("Event Destinations")?></th></tr>
							<?php 
								if (count($sim_ipdst) < 1) 
								{ 
									?>
									<tr><td><?php echo _("No destinations found")?></td></tr>
									<?php 
								} 
								else 
								{ 
			...
			<table>
				<tr>
					<td style="text-align:right;padding-right:20px">
						<a style="color:black" href="../forensics/base_qry_main.php?num_result_rows=-1&submit=Query+DB&current_view=-1&sort_order=time_d&ip=<?php echo urlencode($host)?>&date_range=All"><strong><?php echo gettext("More")?> >></strong></a>
					</td>
				</tr>
			</table>
		</td>
