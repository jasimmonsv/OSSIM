...
function echo_risk($risk,$return=0) {
    ...
    $img = "<img src=\"../pixmaps/risk_yellow.jpg\" width=\"$width\" height=\"15\" />";
    if ($risk > 7) {
        //$img = "<img src=\"../pixmaps/gauge-red.jpg\" " . "width=\"$width\" height=\"15\" />";
        $img = "<img src=\"../pixmaps/risk_red.jpg\" " . "width=\"$width\" height=\"15\" />";
        $echo= "$img $risk";
    } elseif ($risk > 4) {
        //$img = "<img src=\"../pixmaps/gauge-yellow.jpg\" " . "width=\"$width\" height=\"15\" />";
        $img = "<img src=\"../pixmaps/risk_yellow.jpg\" " . "width=\"$width\" height=\"15\" />";
        ...
        $img = "<img src=\"../pixmaps/risk_green.jpg\" " . "width=\"$width\" height=\"15\" />";
        $echo= "$img $risk";
    } else {
        //$img = "<img src=\"../pixmaps/gauge-blue.jpg\" " . "width=\"$width\" height=\"15\" />";
        $img = "<img src=\"../pixmaps/risk_blue.jpg\" " . "width=\"$width\" height=\"15\" />";
        $echo= "$img $risk";
    }
    if ($return==0) {
        echo $echo;
