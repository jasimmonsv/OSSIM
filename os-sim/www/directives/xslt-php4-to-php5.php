...
class php4DOMDocument extends php4DOMNode {
    ...
    function get_elements_by_tagname($name) {
        ...
        $nodeSet = array();
        $i = 0;
        if (isset($myDOMNodeList)) while ($node = $myDOMNodeList->item($i)) {
...
class php4DOMNode {
    ...
    function node_name() {
        if ($this->myDOMNode->nodeType == XML_ELEMENT_NODE) return $this->myDOMNode->localName; //avoid namespace prefix
    ...
    function _importNode($newnode) { //Private function to import DOMNode from another DOMDocument
    ...
    function _newDOMElement($aDOMNode, $aOwnerDocument) { //Private function to check the PHP5 DOMNode before creating a new associated PHP4 DOMNode wrapper
...
class php4DOMNodelist {
    ...
    function php4DOMNodelist($aDOMNodelist, $aOwnerDocument) {
        ...
        $this->nodeset = array();
        $i = 0;
        if (isset($this->myDOMNodelist)) while ($node = $this->myDOMNodelist->item($i)) {
